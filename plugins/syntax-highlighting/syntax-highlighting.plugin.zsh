...
typeset -gH zsynhi_repo
zstyle -s 'zsh_custom:plugin:syntax-highlighting' repo 'zsynhi_repo' \
  || zsynhi_repo=zsh-users/zsh-syntax-highlighting

plugin-load $zsynhi_repo
[[ $zsynhi_repo == zsh-users/zsh-syntax-highlighting ]] || return

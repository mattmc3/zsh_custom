...
zstyle -s ':zsh_custom:lib:editor' wordchars 'WORDCHARS' \
  || WORDCHARS='*?_-.[]~&;!#$%^(){}<>'
...
function zle-reset-prompt {
  if zstyle -t ':zsh_custom:lib:editor' ps-context; then
...
function expand-or-complete-with-indicator {
  local indicator
  zstyle -s ':zsh_custom:lib:editor:info:completing' format 'indicator'
...
for keymap in 'emacs' 'viins'; do
  ...
  # Expand .... to ../..
  if zstyle -t ':zsh_custom:lib:editor' dot-expansion; then
...
# Set the key layout.
zstyle -s ':zsh_custom:lib:editor' key-bindings 'key_bindings'
